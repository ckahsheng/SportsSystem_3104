...
$sqltran = mysqli_query($link, "SELECT userid,role,created_at,emailAddress,phoneNumber,chargeRate,verified,description FROM users WHERE role !='admin' && ((verified='Not Verified') || (verified='Rejected'))")or die(mysqli_error($con));
$arrVal = array();
$i = 1;
